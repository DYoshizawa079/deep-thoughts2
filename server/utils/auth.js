...
module.exports = {
  ...
  // authMiddleware is a function that reads & verifies the token that's in a user's API request
  // The token is read from the HTTP header that accompanies the request
